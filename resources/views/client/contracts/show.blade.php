    ...
    <div class="contract-detail-page space-y-5">
        ...
        <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="p-5 sm:p-6">
                ...
                <div class="mt-3 grid gap-3 sm:grid-cols-2">
                    <div class="flex items-center gap-3 rounded-xl border border-indigo-100 bg-indigo-50/60 p-4"><span class="flex h-9 w-9 items-center justify-center rounded-lg bg-white text-indigo-600 shadow-sm"><i class="bx bx-wifi text-xl"></i></span><div><p class="text-sm font-bold text-indigo-950">Internet</p><p class="mt-0.5 text-xs text-indigo-700">{{ number_format((float) $setting->internet_fee, 0, ',', '.') }}đ/phòng/tháng</p></div></div>
                    <div class="flex items-center gap-3 rounded-xl border border-indigo-100 bg-indigo-50/60 p-4"><span class="flex h-9 w-9 items-center justify-center rounded-lg bg-white text-indigo-600 shadow-sm"><i class="bx bx-home-heart text-xl"></i></span><div><p class="text-sm font-bold text-indigo-950">Dịch vụ chung</p><p class="mt-0.5 text-xs text-indigo-700">{{ number_format((float) $setting->service_fee, 0, ',', '.') }}đ/tháng</p></div></div>
                </div>
