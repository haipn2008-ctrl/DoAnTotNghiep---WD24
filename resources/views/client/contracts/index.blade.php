            ...
            @forelse($contracts as $contract)
                @php
                    $status = $contract->isExpiringSoon()
                        ...
                        : ($statuses[$contract->status] ?? ['Không xác định', 'bg-slate-100 text-slate-700']);
                @endphp
