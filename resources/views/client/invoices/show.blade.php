    ...
    <div class="space-y-5">
        ...
        <div class="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
            <div>
                ...
                <h2 class="mt-2 text-2xl font-bold text-slate-950">{{ $invoice->invoice_type === \App\Models\Invoice::TYPE_DEPOSIT ? 'Hóa đơn tiền cọc' : 'Hóa đơn tháng '.$invoice->month.'/'.$invoice->year }}</h2>
