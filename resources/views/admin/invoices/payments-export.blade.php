...
@php
    $statusLabels = ['pending' => 'Chờ xác nhận', 'success' => 'Thành công', 'failed' => 'Đã từ chối'];
    $methodLabels = ['cash' => 'Tiền mặt', 'bank_transfer' => 'Chuyển khoản', 'qr' => 'Mã QR'];
@endphp
