...
<div class="mx-auto max-w-7xl space-y-6">
    ...
    <section class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
        ...
        <div class="grid gap-3 p-5 sm:grid-cols-3"><div class="rounded-lg border border-indigo-200 bg-indigo-50 p-4"><p class="text-sm font-semibold text-indigo-950">Internet bắt buộc</p><p class="mt-1 text-xs text-indigo-700">{{ number_format((float) $setting->internet_fee, 0, ',', '.') }}đ/người/tháng</p></div><div class="rounded-lg border border-emerald-200 bg-emerald-50 p-4"><p class="text-sm font-semibold text-emerald-950">Máy lạnh</p></div><div class="rounded-lg border border-indigo-200 bg-indigo-50 p-4"><p class="text-sm font-semibold text-indigo-950">Dịch vụ chung bắt buộc</p><p class="mt-1 text-xs text-indigo-700">{{ number_format((float) $setting->service_fee, 0, ',', '.') }}đ/người/tháng</p></div></div>
