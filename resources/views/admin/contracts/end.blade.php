...
@section('title', 'Kết thúc hợp đồng | Quản lý phòng trọ')
@section('page_title', 'Kết thúc hợp đồng')
...
@section('content')
    <div class="space-y-6">
        ...
        <section class="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <form method="GET" action="{{ route('admin.contracts.end.list') }}" class="grid gap-3 md:grid-cols-[1fr_auto] md:items-end">
                <div>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.contracts.end.list') }}" class="inline-flex h-11 items-center rounded-lg border border-slate-200 px-4 text-sm font-semibold text-slate-600 hover:bg-slate-50">Làm mới</a>
                </div>
            </form>
        </section>
