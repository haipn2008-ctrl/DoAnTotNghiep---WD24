    ...
    <div class="space-y-5 p-4">
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="date" name="members[{{ $index }}][cccd_issue_date]" value="{{ $member['cccd_issue_date'] ?? '' }}" max="{{ today()->toDateString() }}" required class="h-10 w-full rounded-lg border border-slate-200 px-3 text-sm outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">
            ...
            <div>
                ...
                <input name="members[{{ $index }}][cccd_issue_place]" value="{{ $member['cccd_issue_place'] ?? '' }}" required maxlength="255" class="h-10 w-full rounded-lg border border-slate-200 px-3 text-sm outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">
            ...
            <div class="md:col-span-2">
                ...
                <input name="members[{{ $index }}][address]" value="{{ $member['address'] ?? '' }}" required maxlength="500" class="h-10 w-full rounded-lg border border-slate-200 px-3 text-sm outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">
