    ...
    <div class="grid gap-5 p-5 md:grid-cols-2">
        ...
        <div>
            ...
            <select id="gender" name="gender" class="h-11 w-full rounded-lg border border-slate-200 px-3 text-sm">
                ...
                <option value="male" @selected(old('gender', $tenant->gender ?? '') === 'male')>
                    Nam
                </option>

                <option value="female" @selected(old('gender', $tenant->gender ?? '') === 'female')>
                    Nữ
                </option>

                <option value="other" @selected(old('gender', $tenant->gender ?? '') === 'other')>
                    Khác
                </option>
