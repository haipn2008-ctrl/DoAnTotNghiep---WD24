...
<div class="space-y-5">
    <div class="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
        <div><h2 class="text-2xl font-bold text-slate-950">Giấy tạm trú của người thuê</h2></div>
                    ...
                    @forelse($members as $member)
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-4 text-right">
                                ...
                                @else
                                    <a href="{{ route('admin.temporary_residences.create', ['member' => $member->id]) }}"
                                       class="app-icon-action inline-flex items-center justify-center rounded-lg border border-indigo-200 bg-indigo-50 text-indigo-700 transition hover:border-indigo-300 hover:bg-indigo-100"
                                       aria-label="Cập nhật giấy tạm trú"
                                       title="Cập nhật giấy tạm trú">
                                        <i class="bx bx-edit-alt text-lg" aria-hidden="true"></i>
                                        <span class="sr-only">Cập nhật giấy tạm trú</span>
                                    </a>
